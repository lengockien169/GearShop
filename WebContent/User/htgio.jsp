				...
				<td width="800" valign="top">
					<table class="table table-hover">
						...
						<tr height="70px" class="card">
							...
							<td><%=s.getMahang()%></td>
							<td style="min-width: 350px; text-align: center; padding: 3px"><%=s.getTenhang()%></td>
					...
					<div class="bordertt">
						...
						<button
							...
							<i class="fa fa-shopping-cart" aria-hidden="true"></i><a
								class="btn btn-danger" href="ThanhToanController">Thanh toán</a>
						</button>
						<!-- 		<a class="btn btn-danger" href="KhuyenMaiController">Thanh toán</a> -->
					</div>
					</div>
</body>
</html>
