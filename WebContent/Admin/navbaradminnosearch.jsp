...
<body>
	<nav style="background-color: #063970">
		...
		<ul>
			...
			<li><a href="#"><span class="glyphicon"></span>Xin chao, <%=((LoginAdminBean) session.getAttribute("adm")).getTenDangNhap()%></a></li>
			<li><a href="LoginAdminController"><i class="fa fa-sign-out"
