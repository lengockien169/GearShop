...
<body>
	...
	<h2>Nhấn để thêm hàng điện tử</h2>
	...
	<div id="id01" class="modal">
		...
		<form class="modal-content animate" action="QLHangADMINController"
			...
			<div class="container">
				<label>Mã hàng:</label> <input name="txtmahang" id="mh" required />
			</div>
			<div class="container">
				<label>Tên hàng:</label> <input name="txttenhang" id="th" required />
			</div>
			<div class="container">
				<label>Giá:</label> <input name="txtgia" id="gia" required
					type="number" />
			</div>
			<div class="container">
				<label>Số lượng:</label> <input name="txtsl" id="sl" required
					type="number" />
			</div>

			<div class="container">
				<label>Mã loại:</label> <select name="txtmaloai" id="ml" required>
					<%
			...
			<div class="container">
				<label>Bảo hành:</label> <input name="txtbaohanh" id="bh" required />
			</div>
			<div class="container">
				<label>Ảnh:</label> <input type="file" name="txtfile">
			</div>
			<div class="container">
				<label>Hãng sản xuất:</label> <input name="txthangsx" id="hangsx"
					required />
			</div>
			<div class="container">
				...
				<table border="1" width="800" valign="top"
					...
					<thead>
						<tr>
							...
							<th scope="col">Tên hàng điện tử</th>
					...
					<tbody>
						...
						<tr style="text-align: center; height: 40px" class="card">
							...
							<td><%=(i + 1)%></td>
							<td><%=s.getTenHang()%> <br> <img
								style="width: 80px; height: 110px" src="<%=s.getImage()%>"></td>
							<td><%=s.getSoLuong()%></td>
							<td><%=df.format(s.getGia())%>đ</td>
							<td><%=s.getHangSX()%></td>
							<td style="text-align: center"><a style="color: #ec4743"
